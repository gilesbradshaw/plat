...
module.exports = function(app) {
  ...
  app.get('/api/product/:id/items', api.listByProduct);
  app.get('/api/items', api.list);
  app.get('/api/item/:id', api.get);
  app.post('/api/item', api.add);
  app.put('/api/item/:id', api.edit);
  app.delete('/api/item/:id', api.delete);
};
