...
module.exports = function(app) {
  // Module dependencies.
    ...
    var Item = mongoose.models.Category,
    api = {};
  ...
  app.get('/api/categories', api.list);
  app.get('/api/category/:id', api.get);
  app.post('/api/category', api.add);
  app.put('/api/category/:id', api.edit);
  app.delete('/api/category/:id', api.delete);
};
